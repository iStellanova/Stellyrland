    ...
    flake.modules.nixos.default = {
      ...
      config = lib.mkIf config.aspects.programs.browser.enable {
        home-manager.users.${identity.name} = {
          ...
          home.file = let
            profile = "${config.aspects.programs.browser.profileId}.Default Profile";
          in {
            ...
            ".config/zen/${profile}/chrome/userChrome.css".text = ''
              ...
              /* 5. Remove all borders, outlines, and box-shadows across all main UI components for a premium borderless aesthetic. */
              #navigator-toolbox,
