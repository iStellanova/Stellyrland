            ...
            Transition {
                ...
                SequentialAnimation {
                    ...
                    ParallelAnimation {
                        ...
                        NumberAnimation { target: menuContainer; property: "anchors.bottomMargin"; duration: Services.Colors.animLarge; easing.type: Easing.BezierSpline; easing.bezierCurve: Services.Colors.curveExpressiveSpatial }
                    }
                }
            },
            Transition {
                ...
                NumberAnimation { target: menuContainer; property: "anchors.bottomMargin"; duration: Services.Colors.animFast; easing.type: Easing.BezierSpline; easing.bezierCurve: Services.Colors.curveEmphasizedAccel }
            }
        ]
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    implicitHeight: 80
                    radius: Services.Colors.radiusLarge
                    color: delayMouse.containsMouse ? Services.Colors.alpha(Services.Colors.primary, 0.2) : "transparent"
                    border.width: 1
