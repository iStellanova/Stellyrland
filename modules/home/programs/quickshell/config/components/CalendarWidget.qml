            ...
            GridLayout {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color: isToday ? Services.Colors.alpha(Services.Colors.primary, 0.2) : (dayMouseArea.containsMouse && isValidDay ? Services.Colors.alpha(Qt.color("white"), 0.1) : "transparent")
