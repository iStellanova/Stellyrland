...
PanelWindow {
    ...
    visible: open || fadeOutTimer.running

    Timer {
        id: fadeOutTimer
        interval: Services.Colors.animSlow + 50
        running: false
        repeat: false
    }
    ...
    Timer {
        id: clearTimer
        interval: fadeOutTimer.interval
        running: fadeOutTimer.running
        onTriggered: {
            if (!open) {
                windowsModel.clear()
                searchInput.text = ""
    ...
    MouseArea {
        anchors.fill: parent
        onClicked: Services.ShellData.setPopupVisible("overview", false)
    }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    border.width: 1.5
                    border.color: Services.Colors.alpha(Services.Colors.primary, searchInput.activeFocus ? 0.6 : 0.2)
                    ...
                    RowLayout {
                        ...
                        TextField {
                            ...
                            placeholderTextColor: Services.Colors.alpha(Services.Colors.mainText, 0.5)
                            ...
                            Keys.onPressed: (event) => {
                                if (event.key === Qt.Key_Escape) {
                                    if (text !== "") {
                                        ...
                                        Services.ShellData.setPopupVisible("overview", false)
                                    }
                                    event.accepted = true
                ...
                Rectangle {
                    ...
                    Layout.preferredHeight: 60
                    radius: Services.Colors.radiusLarge
                    color: window.showingAllApps ? Services.Colors.primary : Services.Colors.alpha(Services.Colors.bg, 0.8)
                    border.width: 1.5
            ...
            Item {
                ...
                RecentAppsGrid {
                    ...
                    onAppLaunched: Services.ShellData.setPopupVisible("overview", false)
                    ...
                    RowLayout {
                        ...
                        ListView {
                            ...
                            highlight: Rectangle {
                                ...
                                color: Services.Colors.alpha(Services.Colors.primary, 0.25)
                                border.width: 1
                                border.color: Services.Colors.alpha(Services.Colors.primary, 0.4)
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                radius: Services.Colors.radiusLarge
                                color: Services.Colors.alpha(Services.Colors.bg, 0.4)
                                
                                border.width: modelData.active ? 2 : 1
                                border.color: modelData.active ? Services.Colors.primary : Services.Colors.alpha(Services.Colors.primary, 0.1)
                                ...
                                MouseArea {
                                    ...
                                    onEntered: workspaceBox.color = Services.Colors.alpha(Services.Colors.bg, 0.8)
                                    onExited: workspaceBox.color = Services.Colors.alpha(Services.Colors.bg, 0.6)
                                }
                                ...
                                Repeater {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        readonly property var res: monMeta ? (monMeta.reserved || [0,0,0,0]) : [0,0,0,0]
                                        readonly property real scaleX: innerW / (monW || 1)
                                        readonly property real scaleY: innerH / (monH || 1)

                                        x: 12 + (model.rectX - (monMeta ? monMeta.x : 0)) * scaleX + (res[2] - res[0]) * scaleX / 2
                                        y: 12 + (model.rectY - (monMeta ? monMeta.y : 0)) * scaleY + (res[3] - res[1]) * scaleY / 2
                                        ...
                                        color: {
                                            let base = !appIcon.isFallback 
                                                ? Services.Colors.alpha(Services.Colors.primary, 0.25)
                                                : Qt.rgba(1, 1, 1, 0.2)
                                            return windowMouseArea.containsMouse ? Services.Colors.alpha(Services.Colors.primary, 0.4) : base
                                        }
                                        border.width: windowMouseArea.containsMouse ? 2 : 1
                                        border.color: windowMouseArea.containsMouse ? Services.Colors.primary : Services.Colors.alpha(Services.Colors.primary, 0.1)

                                        scale: windowMouseArea.containsMouse ? 1.05 : 1.0
