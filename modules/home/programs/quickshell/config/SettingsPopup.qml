...
FloatingWindow {
    ...
    component StyledTextField : TextField {
        ...
        selectionColor: Services.Colors.alpha(Services.Colors.primary, 0.3)
    }
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                height: 40
                                radius: Services.Colors.radiusSmall
                                color: parent.activeTab === modelData.id ? Services.Colors.alpha(Services.Colors.primary, 0.15) : (sidebarMouse.containsMouse ? Services.Colors.alpha(Qt.color("white"), 0.05) : "transparent")
                ...
                StackLayout {
                    ...
                    ScrollView {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                Layout.fillWidth: true
                                Components.ShadowText { text: "Show Notification Timer"; font.pixelSize: 12; color: Services.Colors.mainText; Layout.fillWidth: true }
                                Components.ModernToggle {
                                    checked: (editingSettings.notifications && editingSettings.notifications.show_timer) !== false
                                    onToggled: (isOn) => { if (editingSettings.notifications) { editingSettings.notifications.show_timer = isOn; root.refreshSettings() } }
                                }
                            }
                        }
                    }
                    ...
                    ScrollView {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                Layout.fillWidth: true
                                Components.ShadowText { text: "Use Celsius for Weather"; font.pixelSize: 12; color: Services.Colors.mainText; Layout.fillWidth: true }
                                Components.ModernToggle {
                                    checked: (editingSettings.weather && editingSettings.weather.celsius) || false
                                    onToggled: (isOn) => { if (editingSettings.weather) { editingSettings.weather.celsius = isOn; root.refreshSettings() } }
                                }
                            }
                    ...
                    ScrollView {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                Layout.fillWidth: true
                                Components.ShadowText { text: "Use Hardcoded Colors (Bypass Matugen/Pywal)"; font.pixelSize: 12; color: Services.Colors.mainText; Layout.fillWidth: true }
                                Components.ModernToggle {
                                    id: useHardcodedCheck
                                    checked: (editingSettings.colors && editingSettings.colors.use_hardcoded) || false
                                    onToggled: (isOn) => { if (editingSettings.colors) { editingSettings.colors.use_hardcoded = isOn; root.refreshSettings() } }
                                }
                            }
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Components.ActionButton {
                        ...
                        borderColor: Services.Colors.alpha(Services.Colors.primary, 0.35)
